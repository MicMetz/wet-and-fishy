    ...
    function (BASIS) {
      ...
      function extendError(baseErrorType, errorName) {
        ...
        errorClass.prototype.toString    = function () {
          if (this.message === undefined) {return this.name} else {return this.name + ": " + this.message}
        };
        return errorClass
      }
      ...
      function dynCall(sig, ptr, args) {
        if (sig.indexOf("j") != -1) {return dynCallLegacy(sig, ptr, args)}
      ...
      function embind__requireFunction(signature, rawFunction) {
        ...
        function makeDynCaller() {
          if (signature.indexOf("j") != -1) {return getDynCaller(signature, rawFunction)}
      ...
      function __embind_register_enum(rawType, name, size, isSigned) {
        ...
        ctor.values = {};
        registerType(rawType, {
          name: name, constructor: ctor, "fromWireType": function (c) {
      ...
      function __emval_get_global(name) {
        if (name === 0) {return __emval_register(emval_get_global())} else {
